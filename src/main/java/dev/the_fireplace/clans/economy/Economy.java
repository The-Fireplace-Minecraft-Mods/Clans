...
{//TODO convert this file to a singleton injectable
    private static ExternalEconomy externalEconomy = new DummyEconomy();

    public static void setExternalEconomy(ExternalEconomy externalEconomy) {
        Economy.externalEconomy = externalEconomy;
    }
     ...
     * @return True if the amount was deducted from the account, false if the account doesn't exist or the account doesn't have enough money.
     */
     ...
     *
     * @param amount  The amount to try to deduct
     * @param account The account to deduct from
     * @return The amount not deducted from the account. This should be 0 unless the account did not have enough funds to pay the full amount.
     */
     ...
     * @param account The account to add it to
     * @return True if the amount was added, or false if the account doesn't exist.
     */
     ...
     * @return The account balance. Returns -1 if account not found.
     */
