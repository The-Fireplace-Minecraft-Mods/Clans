...
public class EntityUtil
{
    ...
    public static Chunk findSafeChunkFor(ServerPlayerEntity player, ChunkPosition origin, boolean excludeOrigin) {
    ...
    public static Chunk findSafeChunkFor(ServerPlayerEntity player, ChunkPosition origin) {
