...
public final class PlayerClanSettings
{
     ...
     *
     * @param player              The player to check and update (if needed)
     * @param checkForDefaultClan The clan the player is being removed from. Use null to forcibly change the player's default clan, regardless of what it currently is.
     */
