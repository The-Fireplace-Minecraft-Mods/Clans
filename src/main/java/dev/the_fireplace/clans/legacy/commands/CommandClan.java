...
import dev.the_fireplace.clans.legacy.commands.config.clan.*;
import dev.the_fireplace.clans.legacy.commands.config.player.CommandSetDefault;
import dev.the_fireplace.clans.legacy.commands.config.player.CommandTerritoryMessageMode;
import dev.the_fireplace.clans.legacy.commands.config.player.CommandUndergroundMessages;
import dev.the_fireplace.clans.legacy.commands.details.*;
import dev.the_fireplace.clans.legacy.commands.finance.CommandAddFunds;
import dev.the_fireplace.clans.legacy.commands.finance.CommandBalance;
import dev.the_fireplace.clans.legacy.commands.finance.CommandSetRent;
import dev.the_fireplace.clans.legacy.commands.finance.CommandTakeFunds;
import dev.the_fireplace.clans.legacy.commands.invites.CommandAccept;
import dev.the_fireplace.clans.legacy.commands.invites.CommandAutoDecline;
import dev.the_fireplace.clans.legacy.commands.invites.CommandDecline;
import dev.the_fireplace.clans.legacy.commands.invites.CommandInvite;
import dev.the_fireplace.clans.legacy.commands.land.*;
import dev.the_fireplace.clans.legacy.commands.lock.*;
import dev.the_fireplace.clans.legacy.commands.members.CommandDemote;
import dev.the_fireplace.clans.legacy.commands.members.CommandKick;
import dev.the_fireplace.clans.legacy.commands.members.CommandLeave;
import dev.the_fireplace.clans.legacy.commands.members.CommandPromote;
import dev.the_fireplace.clans.legacy.commands.teleportation.CommandHome;
import dev.the_fireplace.clans.legacy.commands.teleportation.CommandTrapped;
...
public class CommandClan extends CommandBase
{
    ...
    public void execute(@Nullable MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (ClanNames.isClanNameUsed(tag) && args.length >= 2) {
            ...
            UUID defaultClan = sender instanceof ServerPlayerEntity ? PlayerClanSettings.getDefaultClan(((ServerPlayerEntity) sender).getUniqueID()) : null;
