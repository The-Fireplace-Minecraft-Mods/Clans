...
import dev.the_fireplace.clans.networking.SynchronizedMessageQueue;
...
public class ClaimMapToChat extends VirtualClaimMap
{
    ...
    public static void sendSingleFancyMap(ServerPlayerEntity targetPlayer) {
        createFancyMap(targetPlayer, new ChunkPos(targetPlayer.getPosition()), targetPlayer.dimension).prepareAndSend();
    }

    public static void sendAllFancyMaps(ServerPlayerEntity targetPlayer) {
