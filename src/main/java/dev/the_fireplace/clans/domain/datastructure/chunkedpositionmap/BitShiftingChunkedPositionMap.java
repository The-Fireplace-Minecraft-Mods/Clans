...
public abstract class BitShiftingChunkedPositionMap<T> extends ChunkedPositionMap<T>
{
    protected final int chunkSize;

    /**
     * Create a ChunkedPositionMap with chunks of size 2^chunkSize x 2^chunkSize
     */
    protected BitShiftingChunkedPositionMap(int chunkSize) {
