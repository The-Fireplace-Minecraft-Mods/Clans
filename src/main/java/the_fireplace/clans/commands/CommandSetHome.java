...
public class CommandSetHome extends ClanSubCommand {
	...
	public void run(@Nullable MinecraftServer server, EntityPlayerMP sender, String[] args) {
		...
		if(c.hasCapability(Clans.CLAIMED_LAND, null) && ClanCache.getPlayerClan(sender.getUniqueID()).getClanId().equals(Objects.requireNonNull(c.getCapability(Clans.CLAIMED_LAND, null)).getFaction())) {
