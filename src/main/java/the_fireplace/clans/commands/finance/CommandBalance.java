...
public class CommandBalance extends ClanSubCommand {
	...
	public void run(MinecraftServer server, EntityPlayerMP sender, String[] args) {
		if(!selectedClan.isServer()) {
			...
			sender.sendMessage(TranslationUtil.getTranslation(sender.getUniqueID(), "commands.clan.balance.balance", selectedClan.getName(), Clans.getPaymentHandler().getCurrencyString(balance)).setStyle(TextStyles.GREEN));
		} else
