        ...
        if (!pointSearchMap.isEmpty()) {
            ...
            do {
                ...
                if (curEdge != null) {
                    ...
                    ClansModContainer.getMinecraftHelper().getLogger().error("Unable to successfully trace claim chunk perimeter. This claim will not be visible on dynmap.");
                    bTraceError = true;
                    break;
                }
                ...
                if (nLoopLimit <= 0) {
                    ClansModContainer.getMinecraftHelper().getLogger().error("Unable to find starting point in claim trace. This claim will not be visible on dynmap.");
                    bTraceError = true;
                    break;
                }
