...
public class OpCommandSetDescription extends OpClanSubCommand {
	...
	protected void runFromAnywhere(MinecraftServer server, ICommandSender sender, String[] args) {
		...
		if(c != null) {
            ...
            c.getClanMetadata().setDescription(newDescription.toString());
            sender.sendMessage(TranslationUtil.getTranslation(sender, "commands.clan.setdescription.success", c.getClanMetadata().getClanName()).setStyle(TextStyles.GREEN));
		} else
