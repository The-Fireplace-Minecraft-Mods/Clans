...
public final class NewRaidBlockPlacementDatabase {
    ...
    private static void load() {
        ...
        try {
            Object obj = jsonParser.parse(new FileReader(new File(ServerLifecycleHooks.getCurrentServer().getWorld(DimensionType.OVERWORLD).getSaveHandler().getWorldDirectory(), "raidblockplacement.json")));
    ...
    public static void save() {
        ...
        try {
            FileWriter file = new FileWriter(new File(ServerLifecycleHooks.getCurrentServer().getWorld(DimensionType.OVERWORLD).getSaveHandler().getWorldDirectory(), "raidblockplacement.json"));
